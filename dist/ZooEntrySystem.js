    ...
    return function (target, context) {
        return class extends target {
            constructor(...args) {
                super(...args);
                if (args[1] < minAge) {
                    throw new Error(`🚫 Access Denied: ${args[0]} is under ${minAge} and cannot enter the zoo!`);
                }
            }
        };
    };
...
let ZooGuest = (() => {
    let _classDecorators = [AgeRestriction(12)];
    ...
    var ZooGuest = class {
        ...
        static {
            ...
            ZooGuest = _classThis = _classDescriptor.value;
